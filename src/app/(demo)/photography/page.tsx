...
export default function PhotoFujiPage() {
  return (
    <MotionWrapper>
      <div className="container mx-auto p-6">
        <h1 className="mb-6 text-3xl font-bold">My Photos</h1>
        <Card className="relative overflow-hidden">
          <FullscreenButton
            targetId="photo-fuji-iframe"
            className="absolute right-2 top-2 z-10 flex items-center space-x-1 rounded-full px-3 py-1 text-xs backdrop-blur-sm"
          />
          <iframe
            id="photo-fuji-iframe"
            src="https://siyuphotos.vercel.app/grid"
            className="h-[calc(100vh-200px)] w-full border-0"
            title="Web of My Photos"
